...
class Ur5Moveit:
    ...
    def attach_box(self, timeout=1):
        #Found a contact between 'package$1' (type 'Object') and 'vacuum_gripper_link' (type 'Robot link'), which constitutes a collision. Contact information is not stored.
        ...
        self._scene.attach_box(self._eef_link, self._box_name, touch_links='vacuum_gripper_link')
