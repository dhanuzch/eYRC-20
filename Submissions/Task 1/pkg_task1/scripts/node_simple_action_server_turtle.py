#!/usr/bin/env python
"""ROS Node - Simple Action Server - Turtle by @dhanuzch"""
import time
import math
import rospy
import actionlib
...
class SimpleActionServerTurtle:
    """Class to receive and process goals from client"""
    ...
    def __init__(self):
        ...
        self._sas = actionlib.SimpleActionServer('/action_turtle',
                                                 ...
                                                 auto_start=False)
        '''
        * '/action_turtle' - The name of the action that will be used by ROS Nodes to communicate
        * with this Simple Action Server.
        * msgTurtleAction - The Message Class that is used by ROS Actions internally
        * execute_cb - Holds the function pointer to the function which will process incoming Goals
        * auto_start = Only when self._sas.start() is called this Simple Action Server will start.
        '''
...
def main():
    ...
    handle_sub_pose = rospy.Subscriber(obj_server._config_ros_sub_topic, Pose,
